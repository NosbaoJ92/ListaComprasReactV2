// GIT comandos para adicionar os arquivos editados:
// git add. (carregar todas as alterações)
// git commit -m "versionamento"
// git push - para enviar para a origem


// Código corrigido com os principais ajustes estruturais:
// - remoção de variáveis indefinidas (isAdmin, isMenuOpen, userAccountInfo, handleNavigation)
// - correção de localStorage inconsistente
// - proteção em parseFloat
// - organização dos handlers
// - correção do botão Exportar ocupando 2 colunas
// - estabilidade do scanner e fechamento de modal
